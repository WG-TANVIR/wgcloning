...
FB:https://www.facebook.com/TANVIRurDAD1
=========================================="""
logo1 = """
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Tanvir_Hossain 
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;94mWrong Password"
            os.system('xdg-open https://www.facebook.com/TANVIRurDAD1')
    else:
...
def login():
	...
	print logo
        ...
        time.sleep(0.05)
        print "\033[1;93m-•◈•-\033[1;91m> \033[1;93m2.\x1b[1;94m SPIDER  Facebook   "
        time.sleep(0.05)
        print "\033[1;93m-•◈•-\033[1;91m> \033[1;93m3.\x1b[1;91m   "
        time.sleep(0.05)
